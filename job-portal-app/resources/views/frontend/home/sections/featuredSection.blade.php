            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                <div class="card-grid-2 hover-up">
                    <div class="card-grid-2-image-left">
                        ...
                        <div class="image-box">
                            <img class="img-responsive" src="{{ asset('frontend/assets/imgs/brands/brand-1.png') }}" alt="joblist" />
                        </div>
                    </div>
                    <div class="card-block-info">
                        ...
                        <div class="mt-5">
                            ...
                            <span class="card-time">4<span> minutes ago</span></span>
                        </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                <div class="card-grid-2 hover-up">
                    <div class="card-grid-2-image-left">
                        <span class="flash"></span>
                        <div class="image-box">
                            <img class="img-responsive" src="{{ asset('frontend/assets/imgs/brands/brand-2.png') }}" alt="joblist" />
                        </div>
                    </div>
                    <div class="card-block-info">
                        ...
                        <p class="font-sm color-text-paragraph mt-15">Lorem ipsum dolor sit amet, consectetur adipisicing
                            elit. Recusandae architecto eveniet, dolor quo repellendus pariatur.</p>
                        <div class="mt-30">
                            <a class="btn btn-grey-small mr-5" href="jobs-grid.html">React</a>
                            <a class="btn btn-grey-small mr-5" href="jobs-grid.html">NodeJS</a>
                        </div>
                        <span class="card-text-price">$500<b>/Hour</b> </span>
                        <div class="btn btn-apply-now" data-bs-toggle="modal" data-bs-target="#ModalApplyJobForm">
                            Apply now
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                <div class="card-grid-2 hover-up">
                    <div class="card-grid-2-image-left">
                        <span class="flash"></span>
                        <div class="image-box">
                            <img class="img-responsive" src="{{ asset('frontend/assets/imgs/brands/brand-4.png') }}" alt="joblist" />
                        </div>
                    </div>
                    <div class="card-block-info">
                        ...
                        <p class="font-sm color-text-paragraph mt-15">Lorem ipsum dolor sit amet, consectetur adipisicing
                            elit. Recusandae architecto eveniet, dolor quo repellendus pariatur.</p>
                        <div class="mt-30">
                            <a class="btn btn-grey-small mr-5" href="jobs-grid.html">Typescript</a>
                            <a class="btn btn-grey-small mr-5" href="jobs-grid.html">Java</a>
                        </div>
                        <span class="card-text-price">$500<b>/Hour</b></span>
                        <div class="btn btn-apply-now" data-bs-toggle="modal" data-bs-target="#ModalApplyJobForm">
                            Apply now
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                <div class="card-grid-2 hover-up">
                    <div class="card-grid-2-image-left">
                        <span class="flash"></span>
                        <div class="image-box">
                            <img class="img-responsive" src="{{ asset('frontend/assets/imgs/brands/brand-5.png') }}" alt="joblist" />
                        </div>
                    </div>
                    <div class="card-block-info">
                        ...
                        <p class="font-sm color-text-paragraph mt-15">Lorem ipsum dolor sit amet, consectetur adipisicing
                            elit. Recusandae architecto eveniet, dolor quo repellendus pariatur</p>
                        <div class="mt-30">
                            <a class="btn btn-grey-small mr-5" href="jobs-grid.html">Angular</a>
                        </div>
                        <span class="card-text-price">$500<b>/Hour</b></span>
                        <div class="btn btn-apply-now" data-bs-toggle="modal" data-bs-target="#ModalApplyJobForm">
                            Apply now
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                <div class="card-grid-2 hover-up">
                    <div class="card-grid-2-image-left">
                        <span class="flash"></span>
                        <div class="image-box">
                            <img class="img-responsive" src="{{ asset('frontend/assets/imgs/brands/brand-6.png') }}" alt="joblist" />
                        </div>
                    </div>
                    <div class="card-block-info">
                        ...
                        <p class="font-sm color-text-paragraph mt-15">Lorem ipsum dolor sit amet, consectetur adipisicing
                            elit. Recusandae architecto eveniet, dolor quo repellendus pariatur.</p>
                        <div class="mt-30">
                            <a class="btn btn-grey-small mr-5" href="job-details.html">PHP</a>
                            <a class="btn btn-grey-small mr-5" href="job-details.html">Android</a>
                        </div>
                        <span class="card-text-price">$500<b>/Hour</b></span>
                        <div class="btn btn-apply-now" data-bs-toggle="modal" data-bs-target="#ModalApplyJobForm">
                            Apply now
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                <div class="card-grid-2 hover-up">
                    <div class="card-grid-2-image-left">
                        <span class="flash"></span>
                        <div class="image-box">
                            <img class="img-responsive" src="{{ asset('frontend/assets/imgs/brands/brand-7.png') }}" alt="joblist" />
                        </div>
                    </div>
                    <div class="card-block-info">
                        ...
                        <p class="font-sm color-text-paragraph mt-15">Lorem ipsum dolor sit amet, consectetur adipisicing
                            elit. Recusandae architecto eveniet, dolor quo repellendus pariatur.</p>
                        <div class="mt-30">
                            <a class="btn btn-grey-small mr-5" href="job-details.html">ASP .Net</a>
                            <a class="btn btn-grey-small mr-5" href="job-details.html">Figma</a>
                        </div>
                        <span class="card-text-price">$500<b>/Hour</b></span>
                        <div class="btn btn-apply-now" data-bs-toggle="modal" data-bs-target="#ModalApplyJobForm">
                            Apply now
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                <div class="card-grid-2 hover-up">
                    <div class="card-grid-2-image-left">
                        <span class="flash"></span>
                        <div class="image-box">
                            <img class="img-responsive" src="{{ asset('frontend/assets/imgs/brands/brand-8.png') }}" alt="joblist" />
                        </div>
                    </div>
                    <div class="card-block-info">
                        ...
                        <p class="font-sm color-text-paragraph mt-15">Lorem ipsum dolor sit amet, consectetur adipisicing
                            elit. Recusandae architecto eveniet, dolor quo repellendus pariatur.</p>
                        <div class="mt-30">
                            <a class="btn btn-grey-small mr-5" href="job-details.html">iOS</a>
                            <a class="btn btn-grey-small mr-5" href="job-details.html">Laravel</a>
                            <a class="btn btn-grey-small mr-5" href="job-details.html">Golang</a>
                        </div>
                        <span class="card-text-price">$500<b>/Hour</b></span>
                        <div class="btn btn-apply-now" data-bs-toggle="modal" data-bs-target="#ModalApplyJobForm">
                            Apply now
