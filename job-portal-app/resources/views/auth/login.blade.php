...
<section class="pt-120 login-register mb-4">
    ...
    <div class="row">
        ...
        <div class="login-register-cover">
            ...
            <p class="font-sm text-muted mb-30">Please provide valid sign in.</p>
            </div>
            ...
            <div class="row">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" style="margin-right: 5px;" type="checkbox" name="type" id="remember">
